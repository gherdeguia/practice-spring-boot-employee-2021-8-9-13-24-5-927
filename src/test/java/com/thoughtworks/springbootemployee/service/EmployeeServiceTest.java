...
////        PageImpl<Employee> employeePages = new PageImpl<Employee>(employees);
////        given(employeesRepository.findAll(PageRequest.of(1, 3))).willReturn(employeePages);
//////
////        //when
////        List<Employee> actualEmployees = employeeService.getEmployeesByPageService(1,3);
////
////        //then
...
//        //given
//        List<Employee> employees = new ArrayList<>();
//        employees.add(new Employee("Lorenz", 21, "male", 800));
//        employees.add(new Employee("Falcon", 21, "male", 2000));
//        employees.add(new Employee("tomB", 20, "female", 1000));
//        given(employeesRepository.findAll()).willReturn(employees);
//        //when
//        employeeService.addNewEmployeeService(new Employee("Edward", 20, "male", 14567));
//        //then
//        assertEquals(employeeService.getAllEmployeesService().size(), 4);
